...
Invoke-B1HostChecks -HostKey 'BJ-CL01' -Report:$requestedReport -ReportDir $requestedReportDir -NoPause:$requestedNoPause -StartFromAspect $requestedStartFromAspect
