...
Invoke-B1HostChecks -HostKey 'SHA-DC01' -Report:$requestedReport -ReportDir $requestedReportDir -NoPause:$requestedNoPause -StartFromAspect $requestedStartFromAspect
