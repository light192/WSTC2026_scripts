...
Invoke-B1HostChecks -HostKey 'SHA-APP01' -Report:$requestedReport -ReportDir $requestedReportDir -NoPause:$requestedNoPause -StartFromAspect $requestedStartFromAspect
